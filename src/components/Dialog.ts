...
const DIALOGS: ILevelDialog[] = [
	{
		...
		answers: ['nadya', 'nadya ismuha', 'nadyaismuha'],
		hint: '(?) This game is made for my future wife...'
	},
	{
		question:
			'siapa lelaki terbaik bagi kamu?<br>' +
			'<span class="dialog-hint">(someone you love)</span>',
		answers: [
			'taufiq',
      'taufiqurrahman',
      'fiqgant',
      ...
      'ismuha',
		...
		hint: '(?) Come on, you know who it is! or your father maybe?'
	},
	{
